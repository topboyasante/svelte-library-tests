...
export default function main() {
  ...
  group('page_1 - https://svelte-library-auth-3-0.vercel.app/auth/dashboard', function () {
    response = http.get('https://svelte-library-auth-3-0.vercel.app/favicon.png', {
      headers: {
        referer:
          'https://svelte-library-auth-3-0.vercel.app/auth/dashboard/book/65561db82e04d1be35965321',
        'user-agent':
    ...
    response = http.get(
      'https://node-library-spg2.onrender.com/api/v1/books/65561db82e04d1be35965321',
      {
        headers: {
    ...
    response = http.get('https://svelte-library-auth-3-0.vercel.app/favicon.png', {
      headers: {
        referer:
          'https://svelte-library-auth-3-0.vercel.app/auth/dashboard/book/edit/65561db82e04d1be35965321',
        'user-agent':
          'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
        'sec-ch-ua': '"Brave";v="119", "Chromium";v="119", "Not?A_Brand";v="24"',
        'sec-ch-ua-mobile': '?0',
...
export function handleSummary(data) {
  return {
    "edit-book-report.html": htmlReport(data),
  };
}